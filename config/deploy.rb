...
role :web, "www.dailymugshot.com"                          # Your HTTP server, Apache/etc
role :app, "www.dailymugshot.com"                          # This may be the same as your `Web` server
role :db,  "www.dailymugshot.com", :primary => true # This is where Rails migrations will run
